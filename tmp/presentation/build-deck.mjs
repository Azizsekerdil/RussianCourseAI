...
async function main() {
  ...
  // 7 — Platforms & download: v1.1.1 release availability with the private-repo caveat.
  {
    const slide = deck.slides.add();
    slide.background.fill = C.white;
    ...
    const rows = [
      { label: "TÜRKÇE", color: C.ink, body: "Windows 10/11 (x64) + macOS (Apple Silicon) — İndirme: github.com/Azizsekerdil/RussianCourseAI/releases (v1.1.1) (özel repo)" },
      { label: "ENGLISH", color: C.blue, body: "Windows 10/11 (x64) & macOS (Apple Silicon) — Download: GitHub Releases (v1.1.1)" },
      { label: "РУССКИЙ", color: C.muted, body: "Windows 10/11 (x64) и macOS (Apple Silicon) — Загрузка: GitHub Releases (v1.1.1)" },
    ];
    ...
    text(
      slide,
      "platform-footnote",
      "Release v1.1.1 — iki paket: Windows zip + macOS zip. macOS paketi Apple Silicon (arm64) içindir ve notarize edilmemiştir; ilk açılışta sağ tık → Aç.\nDepo özel (private) — github.com/Azizsekerdil/RussianCourseAI bağlantısına yalnızca hesap sahibi erişebilir.",
      42, 576, 1120, 84, 15,
      { color: C.muted },
    );
    footer(slide, 7);
    notes(slide, [
      "https://github.com/Azizsekerdil/RussianCourseAI/releases/tag/v1.1.1 (v1.1.1 release with Windows and macOS zip assets; private repository)",
    ]);
  }
